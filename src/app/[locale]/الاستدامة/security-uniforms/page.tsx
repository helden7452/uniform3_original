...
export const metadata: Metadata = {
  title: 'الاستدامة في زي الأمن | خبراء الزي الموحد',
  description: 'اكتشف كيفية تحقيق الاستدامة في تصميم وإنتاج زي الأمن مع التركيز على الجودة والمسؤولية البيئية',
  keywords: ['استدامة زي الأمن', 'زي أمن مستدام', 'ملابس أمن صديقة للبيئة', 'زي أمن مسؤول'],
};
...
export default function SustainabilitySecurityUniformsPage({ params }: Props) {
  return (
    <CategoryPage
