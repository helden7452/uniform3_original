...
const articles = [
  {
    ...
    slug: 'comprehensive-guide-to-choosing-the-right-medical-scrubs',
    excerpt: 'دليل متكامل يساعدك على اختيار الزي الطبي المناسب للمستشفيات والعيادات في المملكة العربية السعودية مع مراعاة المعايير والمتطلبات المحلية.',
    imageSrc: '/images/healthcare_uniforms/scrubs-guide.jpg',
  },
  {
    id: 2,
    ...
    excerpt: 'كيف يساهم الزي الطبي الموحد في تقليل انتشار العدوى والحفاظ على بيئة صحية آمنة ومعقمة في المنشآت الطبية.',
    imageSrc: '/images/healthcare_uniforms/infection-prevention.jpg',
  },
  {
    id: 3,
    title: 'معايير اختيار أقمشة الزي الطبي: مضادة للبكتيريا، مريحة، وسهلة التنظيف',
    slug: 'medical-uniform-fabric-selection-criteria',
    excerpt: 'تعرف على أهم المعايير التي يجب مراعاتها عند اختيار أقمشة الزي الطبي لضمان الراحة والحماية وسهولة العناية.',
    imageSrc: '/images/healthcare_uniforms/medical-fabrics.jpg',
  },
  {
    id: 4,
