...
const articles = [
  ...
  {
    id: 3,
    title: 'أقمشة مريحة ومقاومة للتجعد لزي الطيران: دليل اختيار الخامات',
    slug: 'comfortable-wrinkle-resistant-fabrics-for-aviation-uniforms',
    excerpt: 'تعرف على أفضل أنواع الأقمشة المستخدمة في صناعة أزياء الطيران والتي تتميز بالراحة ومقاومة التجعد للحفاظ على المظهر الأنيق طوال الرحلة.',
    imageSrc: '/images/aviation_uniforms/comfortable-fabrics.jpg',
  },
  {
    id: 4,
    title: 'كيفية اختيار الأقمشة المناسبة لزي طاقم الطيران في المناخ السعودي',
    slug: 'choosing-suitable-fabrics-for-saudi-climate',
    excerpt: 'نصائح متخصصة حول اختيار الأقمشة المثالية لزي الطيران في المناخ السعودي، مع التركيز على الراحة والمظهر الاحترافي.',
    imageSrc: '/images/aviation_uniforms/climate-fabrics.jpg',
  },
  {
    id: 5,
